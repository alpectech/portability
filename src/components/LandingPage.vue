<template>
  <div class="md:hidden flex flex-col flex-wrap flex-auto bg-gray-100">
    ...
    <div class="" id="google-static-map"></div>
  </div>
</template>
